	...
	<section class="no-padding" id="addHobbies">
		<div class="container">
			...
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab" href="#myHobbies">My
						Hobbies</a></li>
				<li><a data-toggle="tab" href="#myEvents">My Events</a></li>
				<li><a data-toggle="tab" href="#addHobby">Add Hobby</a></li>
			</ul>
			<div class="tab-content">
				<div class="tab-content tab-pane fade in active" id="myHobbies">
						...
						<c:if test="${fn:length(userHobbies) gt 0}">
							<c:forEach var="hobby" items="${sessionScope.user.hobbies}">
								<div class="col-lg-2 col-sm-4" style="height:300; background-color: yellow;">
									<a href="viewHobby?hobby=${hobby.hobbyName}" class="portfolio-box"> 
		...
		<div class="tab-pane fade" id="addHobby">
				<h2>Search Hobby</h2>
            <form action="showHobbies" method="post">
            ...
            <div class="panel panel-default" id="hobbyView" style="visibility:hidden">
						<div class="panel-body" style="max-height: 200; overflow-y: scroll;">
	 ...
	 xmlHttp.onreadystatechange = function stateChanged()
	    {
	        if (xmlHttp.readyState == 4)
	        {
	        	...
	        	if(json.result)
	        	{
	        		alert("loadHobbies: true");
	        		response=true;
	        	}
	        	else
	        		{
	        		alert("loadHobbies: false");
	        	//	document.getElementById("alert").style.visibility="visible";
	    ...
	    xmlHttp.send();
	    alert("return from ajax"+response);
	    return response;
}
...
function ValidateHobby()
{
	...
	if(loadHobbies()==true)
		{
		alert("Result validate:"+ loadHobbies());
			return true;
		}
	else
		alert("Result validate:"+ loadHobbies());
