    ...
    <header>
        <div class="header-content">
            ...
            <section id="login">
                ...
                <hr>
                <div class="container-fluid">
                 <spring:form id="loginForm"  name="loginForm" action="login" commandName="userDetails" method="post" class = "form-horizontal" role = "form">
   				<div class = "form-group">
				<div class = "col-sm-offset-2 col-sm-10">	      
				 <label for = "username" class = "col-sm-1 control-label">Username</label>
					<div class="col-sm-5">		
					         <spring:input path="userName" type = "text" class = "form-control" id = "username" placeholder = "Enter Username" required="true"/>
					  </div>  
			   </div>  
			   </div>
					<div class = "form-group ">    
					 <div class = "col-sm-offset-2 col-sm-10">     
					      ...
					      <div class="col-sm-5">
					         <spring:input path="password"  type = "password" class = "form-control" id = "password" placeholder = "Enter Password" required="true"/>
					      </div>
					  </div>
					</div>
					   <div class = "form-group">
                ...
                <spring:form id="myForm" name="myForm" action="registerUser" commandName="userDetails" method="post" class = "form-horizontal" role = "form">
					   ...
					   <div class = "form-group bootstrap-iso">
					      ...
					      <div class = "col-sm-4">
    							...
    							<spring:input path="birthDate" id="birthDate" name="date" type="text" class="form-control" required="true" />
